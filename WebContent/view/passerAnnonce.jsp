    ...
    <div class="container-fluid">
        ...
        <div class="span9">
          ...
          <div class="hero-unit">
			...
			<form id="annonceForm" class="form-horizontal" method="post" action="finishAnnonceForm.html">
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" maxlength="30" pattern="[A-Za-z]{2,24}" name="nom" id="nom" placeholder="Nom" required/>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" maxlength="30" pattern="[A-Za-z]{2,24}" name="prenom" id="prenom" placeholder="Prénom" required/>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="email" maxlength="30" id="email" name="email" placeholder="Ex:membre@faust.fr" required/>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="tel" maxlength="16" pattern="[0-9]*" id="tel" name="tel" placeholder="0612345678">
					</div>
				</div>
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" maxlength="100" pattern="[A-Za-z0-9]{2,100}" name="titre" id="titre" placeholder="Titre" required/>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">						
						<textarea name="description" maxlength="500" id="description" cols="40" rows="4"></textarea>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" maxlength="16" pattern="[0-9]*" name="prix" id="prix" required/>
					</div>
				</div>
		...
		<span class="form_col"></span>
			<button class="btn btn-primary" onClick="submitForms()"> VALIDER L'ANNONCE </button>
