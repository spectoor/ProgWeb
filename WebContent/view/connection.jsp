          	...
          	<h3> CONNECTION: </h3>
          	    ...
          	    <form class="form-horizontal" action="finishConnection.html" method="post">
			    	<div class="control-group">
			    		...
			    		<div class="controls">
			    			<input type="text" id="login" name="login" placeholder="Login" pattern="([a-z]|[0-9]){2,30}" required/>
			    		</div>
			    	</div>
			    	...
			    	<div class="control-group">
			    		...
			    		<div class="controls">
			    			<input type="password" id="pwd" name="pwd" placeholder="Password" pattern="([a-z]|[0-9]|é|&){2,30}"required/>
			    		</div>
			    	</div>
